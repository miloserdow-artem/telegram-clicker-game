...
Пожалуйста, выполните следующие команды в консоли вашего сервера:

1. __Сохранить локальные изменения (stash):__ `git stash` Эта команда сохранит ваши текущие изменения и очистит рабочую директорию.

2. __Получить последние изменения из репозитория (pull):__ `git pull origin main`

После выполнения этих команд, пожалуйста, сообщите мне результат. Если вы хотите вернуть свои локальные изменения после пула, вы можете использовать `git stash pop`
