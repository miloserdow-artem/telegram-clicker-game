...
Разработала полноценную игру‑кликер для Telegram Mini App. Проект реализован в ноябре 2025 года в рамках продвижения собственного Telegram‑канала.

Функционал приложения включал:

1. систему сохранения пользовательских данных;
2. механику заданий;
3. реферальную систему;
4. таблицы лидеров (leaderboard).
5. В рамках проекта был организован месячный ивент: топ‑3 участника по результатам таблицы лидеров получили подписку Telegram Premium. Благодаря реферальной системе аудитория канала увеличилась на 200 подписчиков.

В ходе работы над проектом существенно расширил компетенции в области frontend‑разработки и JavaScript, освоил работу с базами данных и API.
